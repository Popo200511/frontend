        ...
        <div class="content" style="transition: margin-left 0.3s ease-in-out; padding-top: 60px;">
            ...
            <nav
                ...
                <div id="sticky-wrapper" class="sticky-wrapper" style="height: 30px; background: #87ceeb; font-size: 15px">
                    <div class="container">
                        <div class="logoname" style=" height: 30px; display: flex; align-items: center;">
                    ...
                    <tbody>
                        <tr style="font-size: 9px; text-align:center">
                            ...
                            <td><input type="text" class="form-control" style="font-size: 10px; width: 100px; text-align: center;" name="unit" value="{{ $edit->unit }}"
                                    readonly></td>
                            <td>
                                <input type="number" class="form-control" style="font-size: 10px; width: 100px; text-align: center; background: #47d53a;" name="quantity" id="quantityInput"
                                    value="-{{ abs($edit->quantity) }}" required oninput="forceNegativeValue(this)">
                            </td>
    
                            <td><input type="text" class="form-control" style="font-size: 10px; width: 100px; text-align: center; background: #47d53a;" name="remark" value="{{ $edit->remark }}"
                                    required></td>
