                ...
                <table class="table" id="table">
                    ...
                    <tbody>
                        <tr style="font-size: 9px; text-align:center">
                            <td><input class="form-control" style="font-size: 10px; width: 100px; text-align: center;" name="refcode" 
                                 value="{{ $edit->refcode_import }}" readonly>
                            </td>
    
                            <td><input type="text" class="form-control" style="font-size: 10px; width: 100px; text-align: center;" name="Droppoint"
                                value="{{ $edit->droppoint_import }}" readonly></td>

                            <td><input type="text" class="form-control" style="font-size: 10px; width: 110px; text-align: center;" name="material_code"
                                    value="{{ $edit->material_code_import }}" readonly></td>

                            <td><input type="text" class="form-control" style="font-size: 10px; width: 100px; text-align: center;" name="material_name"
                                    value="{{ $edit->material_name_import }}" readonly></td>

                            <td><input type="text" class="form-control" style="font-size: 10px; width: 100px; text-align: center;" name="spec_size_import"
                                    value="{{ $edit->spec_size_import }}" readonly></td>

                            <td><input type="text" class="form-control" style="font-size: 10px; width: 100px; text-align: center;" name="brand" value="{{ $edit->brand }}"
                                    readonly></td>

                            <td><input type="text" class="form-control" style="font-size: 10px; width: 100px; text-align: center;" name="unit" value="{{ $edit->unit }}"
                                    readonly></td>
                            
                            <td>
                                 <input type="hidden" name="quantity" id="quantityHidden"value="-{{ abs($edit->quantity) }}">
                                 <!-- ซ่อนค่าเดิม -->
                                <input type="number" class="form-control" name="quantity_with" id="quantityInput" style="font-size: 10px; width: 100px; text-align: center; background: #47d53a;" name="quantity" id="quantityInput"
                                    value="-{{ abs($edit->quantity) }}" required oninput="forceNegativeValue(this)">
                            </td>
    
                            <td><input type="text" class="form-control" style="font-size: 10px; width: 10rem; text-align: center; background: #47d53a;" name="remark" value="{{ $edit->remark }}"
                                    required></td>
                            <td><input type="text" class="form-control" style="font-size: 10px; width: 100px; text-align: center;" name="date" value="{{ $edit->date }}"
                                    readonly></td>
                            <td><input type="text" class="form-control" style="font-size: 10px; width: 100px; text-align: center;" name="transaction"
                                    value="{{ $edit->transaction }}" readonly></td>
                            <td><input type="text" class="form-control" style="font-size: 10px; width: 100px; text-align: center;" name="import_quantity"
                                    value="{{ $edit->import_quantity }}" readonly></td>
                            <td><input type="text" class="form-control" style="font-size: 10px; width: 100px; text-align: center;" name="name"
