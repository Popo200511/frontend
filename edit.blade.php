        ...
        <div class="content" style="transition: margin-left 0.3s ease-in-out; padding-top: 60px;">
            ...
            <nav
                ...
                <div id="sticky-wrapper" class="sticky-wrapper" style="height: 30px; background: #87ceeb; font-size: 15px">
                    <div class="container">
                        <div class="logoname" style=" height: 30px; display: flex; align-items: center; justify-content: flex-end;">
    ...
    <div class="container ">
     ...
     <form action="/edit/save" method="POST">
        @csrf
            ...
            <div class="texeadd">
                <div class="hi">
                    <h2 style="font-size: 15px;">Edit Data</h2>
                </div>
            </div>
                ...
                <table class="table" id="table">
                    ...
                    <tbody>
                        <tr style="font-size: 9px; text-align:center">
                            <td><input class="form-control" style="font-size: 9px;" name="refcode" 
                                 value="{{ $edit->refcode_import }}" readonly>
                            </td>
    
                            <td><input type="text" class="form-control" style="font-size: 9px;" name="Droppoint"
                                    value="{{ $edit->droppoint_import }}" readonly></td>

                            <td><input type="text" class="form-control" style="font-size: 9px;" name="material_code"
                                    value="{{ $edit->material_code_import }}" readonly></td>

                            <td><input type="text" class="form-control" style="font-size: 9px;" name="material_name"
                                    value="{{ $edit->material_name_import }}" readonly></td>

                            <td><input type="text" class="form-control" style="font-size: 9px;" name="spec_size_import"
                                    value="{{ $edit->spec_size_import }}" readonly></td>

                            <td><input type="text" class="form-control" style="font-size: 9px;" name="brand" value="{{ $edit->brand }}"
                                    readonly></td>

                            <td><input type="text" class="form-control" style="font-size: 9px;" name="unit" value="{{ $edit->unit }}"
                                    readonly></td>
                            <td>
                                <input type="number" class="form-control" style="font-size: 9px; background: #47d53a;" name="quantity" id="quantityInput"
                                    value="-{{ abs($edit->quantity) }}" required oninput="forceNegativeValue(this)">
                            </td>
    
                            <td><input type="text" class="form-control" style="font-size: 9px; background: #47d53a;" name="remark" value="{{ $edit->remark }}"
                                    required></td>
                            <td><input type="text" class="form-control" style="font-size: 9px;" name="date" value="{{ $edit->date }}"
                                    readonly></td>
                            <td><input type="text" class="form-control" style="font-size: 9px;" name="transaction"
                                    value="{{ $edit->transaction }}" readonly></td>
                            <td><input type="text" class="form-control" style="font-size: 9px;" name="import_quantity"
                    ...
                    <a href="/import">
                        <button type="button" class="btn btn-success" style="margin-top: 10px; background-color: #0d6efd;">
                            ย้อนกลับ
                        </button>
                    </a>
