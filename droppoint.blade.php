...
<body>
    ...
    <section class="home-section">
        <div class="text">สถานที่เก็บอุปกรณ์</div>


        <div class="ip">
            <input placeholder="สถานที่เก็บวัสดุ" class="input-style" type="text">
            <input placeholder="พิกัด" class="input-style" type="text">
            <input placeholder="ติดต่อ" class="input-style" type="text">
      ...
      <div class="modal fade show d-block" id="droppointModal" tabindex="-1" role="dialog" aria-labelledby="droppointModalLabel" aria-hidden="true" style="background-color: rgba(0, 0, 0, 0.5);">
          <div class="modal-dialog modal-xl" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                      <h5 class="modal-title" id="droppointModalLabel">ตรวจสอบข้อมูล Droppoint</h5>
                      <input placeholder="กรุณากรอกข้อมูล" class="input-style" type="text" id="search" name="search">
...
<div class="container mt-5">
  <div class="table-wrapper">
    <div class="texeadd">
      <div class="hi">
        <h3 class="mb-4">สถานที่เก็บอุปกรณ์</h3>
        <input placeholder="กรุณากรอกข้อมูล" class="input-style" type="text" id="search" name="search">
      </div>
...
$(document).ready(function () {
    ...
    $('#droppointModal #search').on('keyup', function () {
        var query = $(this).val().toLowerCase(); // รับค่าที่กรอกในช่องค้นหา
        $('#droppointModal #modalTable tbody tr').filter(function () {
