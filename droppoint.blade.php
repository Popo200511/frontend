            ...
            <div class="table-wrapper">
                <div class="texeadd">
                    <div class="hi">
                        ...
                        <input placeholder=" " class="input-style" type="text" id="search"
                            name="search">
                    </div>
                    ...
                    <div class="table-container " style="height: 500px;">
                        <table class="table" id="table">
                            <thead style="font-size: 12px; text-align:center">
                                <tr>
                                    <th style="background-color: skyblue">Droppoint</th>
                                    <th style="background-color: skyblue">พิกัด</th>
                                    <th style="background-color: skyblue">ติดต่อ</th>
                                </tr>
                            </thead>
