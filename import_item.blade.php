                                        ...
                                        @foreach ($import_add as $item)
                                            <tr style="font-size: 10px; text-align:center">
                                                <td>
                                                    ...
                                                    <a href=" {{ route('edit_import', $item->id) }}"><i class='fas fa-pen'
...
<script> function Addsubmit(){ if(confirm("คุณต้องการอัพเดทหรือไม่")){ return true; } else { return false; } }
        ...
        <td><input type="text" name="Remark[]" class="form-control" style="text-align: center; font-size: 9px; border: none; background-color: transparent;" ></td>
