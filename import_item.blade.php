  ...
  <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="materialModalLabel">Material</h4>
...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal" style="width: 70px; height: 40px; text-align: center;">
  ADD
</button>

<!-- Button to Show Data -->
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal" style="width: 100px; height: 40px; text-align: center;">
  ShowData
</button>
