        ...
        <div class="container">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="background-color: skyblue;" style="width: 20rem; text-align: center; vertical-align: middle;">
                                                ...
                                                <div style="display: flex; justify-content: center; align-items: center; margin-top: 5px;">
                                                    <input class="input-style" type="text" id="searchNo" name="searchNo"
                                                        style="width: 90px; height: 20px; padding: 5px; font-size: 10px;">
                                                </div>
                                            </th>
            ...
            <div class="modal fade" id="showDataModal" tabindex="-1" aria-labelledby="showDataModalLabel"
                ...
                <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="showDataModalLabel" style="font-size: 15px;">ประวัติการนำของเข้า</h4>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="background-color: skyblue;" style="text-align: center; vertical-align: middle;">
                                                Material_code
                                                <div style="display: flex; justify-content: center; align-items: center; margin-top: 5px;">
                                                    <input class="input-style" type="text" id="searchMaterial_code" name="searchmaterial_codet"
                                                        style="width: 115px; height: 20px; padding: 5px; font-size: 10px;">
                                                </div>
                                            </th>
                                            ...
                                            <th scope="background-color: skyblue;" style="text-align: center; vertical-align: middle;">
                                                Spec/Size
                                                <div style="display: flex; justify-content: center; align-items: center; margin-top: 5px;">
                                                    <input class="input-style" type="text" id="searchSpec/Size" name="searchspec"
                                                        style="width: 115px; height: 20px; padding: 5px; font-size: 10px;">
                                                </div>
                                            </th>
            ...
            <form class="row g-3 justify-content-center my-2 text-center" autocomplete="off" method="POST"
                ...
                <div class="container">
                    <div class="Rddb" style="display: flex;align-items: flex-end;justify-content: space-between;">
                        ...
                        <div class="col d-flex align-items-center gap-3">
                            ...
                            <div class="col-md-2" style="width: 170px;">
                                <label for="date" class="form-label" style="justify-content: flex-start; display: flex;" >Date</label>
                        ...
                        <div class="but">
                            <button type="button" class="cssbuttons-io" data-bs-toggle="modal" data-bs-target="#showDataModal">
                ...
                <div class="nametable"><span>นำของเข้า</span> <i class="fa-solid fa-warehouse"></i></div>
            ...
            <div class="d-flex justify-content-center my-1">
                <input id="submitButton" class="btn btn-success" type="submit" value="Submit" onclick="return Addsubmit();" style="display: block;">
                <!-- แสดงปุ่ม -->
            </div>
...
<script> function Addsubmit(){ if(confirm("คุณต้องการอัพเดทหรือไม่")){ return true; } else { return false; } }
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function filterTable() {
                ...
                rows.forEach(row => {
                    const refcode = row.cells[1]?.textContent.toLowerCase().trim() || '';
                    const droppoint = row.cells[2]?.textContent.toLowerCase().trim() || '';
                    const materialCode = row.cells[3]?.textContent.toLowerCase().trim() || '';
                    const materialName = row.cells[4]?.textContent.toLowerCase().trim() || '';
                    const spec = row.cells[5]?.textContent.toLowerCase().trim() || '';
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const table = document.querySelector('#materialTable'); // อ้างถึงตาราง
        const filterInputs = [
            '#searchNo',           // ช่องค้นหา No
