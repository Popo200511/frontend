...
<body>
  ...
  @endif
      ...
      <!-- Modal -->
      <div class="modal fade" id="droppointModal" tabindex="-1" aria-labelledby="droppointModalLabel" aria-hidden="true">
  ...
  $(document).ready(function() {
      $('#search').on('keyup', function() {
          ...
          $('#table tbody tr').filter(function() {
              ...
              var col1 = $(this).find('td:nth-child(1)').text().toLowerCase(); // ชื่อ
              var col2 = $(this).find('td:nth-child(2)').text().toLowerCase(); // Spec
