...
<div class="sidebar">
    ...
    <section class="home-section">
        ...
        <div class="container">
            <form action="/material" method="POST" enctype="multipart/form-data" id="csvForm" class="d-flex align-items-center gap-2" style="flex-wrap: nowrap; justify-content: center;">
                @csrf
                <input type="file" class="form-control" name="csv_file_material" accept=".csv" style="width: 300px; height: 29px; font-size: 10px;" required>
                <input type="submit" class="btn btn-primary" name="preview_material" value="แสดงข้อมูล Material ที่ต้องการเพิ่ม"
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="materialModalLabel" style="font-size: 15px">ตรวจสอบข้อมูล Material</h5>
                            <input placeholder="กรุณากรอกข้อมูล" class="input-style" type="text" id="materialSearch"name="materialSearch">
                        ...
                        <div class="modal-footer">
                            <form action="/savematerial" method="POST">
                                ...
                                <button type="submit" class="btn btn-success" onclick="confirmSubmission(event)" style="font-size: 12px; height: 30px;">เพิ่มข้อมูล</button>
                            ...
                            <a href="/material" class="btn btn-danger" style="font-size: 12px; height: 30px;">ย้อนกลับ</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container mt-5">
            <div class="table-wrapper">
                <div class="texeadd">
                    <div class="hi">
                        <h3 class="mb-4" style="display: flex; gap:5px">รายการวัสดุ<i class="fa-solid fa-cart-plus"></i></h3>
                    </div>
                    ...
                    <div class="table-container " style="height: 552px;">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="background-color: skyblue;" style=" text-align: center; vertical-align: middle;">
                                            ...
                                            <div
                                                ...
                                                <input class="input-style" type="text" id="searchMaterial_c" name="searchMaterial_c"
                                        ...
                                        <th scope="background-color: skyblue;" style="text-align: center; vertical-align: middle;">
                                            ...
                                            <div
                                                style="display: flex; justify-content: center; align-items: center; margin-top: 5px;">
                                                <input class="input-style" type="text" id="searchMaterial_n" name="searchMaterial_n"
                                        ...
                                        <th scope="background-color: skyblue;" style="text-align: center; vertical-align: middle;">
                                            ...
                                            <div
                                                style="display: flex; justify-content: center; align-items: center; margin-top: 5px;">
                                                <input class="input-style" type="text" id="searchSpec_size" name="searchSpec_size"
                                                    style="width: 11rem; height: 20px; padding: 5px; font-size: 10px;">
                                            </div>
                                        </th>
