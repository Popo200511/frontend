...
<div class="sidebar">
    ...
    <!-- Content -->
        ...
        <nav style="background: #f8f9fa; position: absolute; top: 0; width: 100%; z-index: 900; box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.1);">
            <div id="sticky-wrapper" class="sticky-wrapper" style="height: 30px; background: #87ceeb; font-size: 15px">
                <div class="container">
                        <div class="name" style=" display: flex; height: 30px; justify-content: space-between; align-items: center; color: #f8f9fa; font-size: 15px;">
        ...
        <div class="container ">
                                    ...
                                    <tbody>
                                        @foreach ($summary as $item)
                                            <tr style="font-size: 10px; text-align:center">
                                                ...
                                                <td>
                                                    <a href="#" data-material-name="{{ $item->material_name }}" style="text-decoration: none; color: #3cb704;"
                ...
                <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="showDataModalLabel" style="font-size: 15px;">ประวัติการเบิกของ</h4>
                        ...
                        <div class="modal-body">
                            <div class="table-container">
                                <table class="table" id="showDataTable">
                                    <thead>
                                        <tr>
                                            <th scope="col" style="align-content: space-around;">Edit</th>

                                        <!-- ค้นหา Refcode -->
                                        <th scope="background-color: skyblue;" style="text-align: center; vertical-align: middle;">
                                            Refcode
                                            <div style="display: flex; justify-content: center; align-items: center; margin-top: 5px;">
                                                <input class="input-style" type="text" id="searchRefcode1" name="searchRefcode1"
                                                    style="width: 115px; height: 25px; padding: 5px; font-size: 12px;">
                                            </div>
                                        </th>
                                        ...
                                        <th scope="background-color: skyblue;" style="text-align: center; vertical-align: middle;">
                                            Refcode_withdraw
                                            <div style="display: flex; justify-content: center; align-items: center; margin-top: 5px;">
                                                <input class="input-style" type="text" id="searchRefcode2" name="searchRefcode2"
                                                    style="width: 115px; height: 25px; padding: 5px; font-size: 12px;">
                                            </div>
                                        </th>
                                        ...
                                        <th scope="background-color: skyblue;" style="text-align: center; vertical-align: middle;">
                                            Material Code
                                            <div style="display: flex; justify-content: center; align-items: center; margin-top: 5px;">
                                                <input class="input-style" type="text" id="searchmaterialcode" name="searchmaterialcode"
                                                    style="width: 115px; height: 25px; padding: 5px; font-size: 12px;">
                                            </div>
                                        </th>
                                        ...
                                        <th scope="background-color: skyblue;" style="text-align: center; vertical-align: middle;">
                                            Material Name
                                            <div style="display: flex; justify-content: center; align-items: center; margin-top: 5px;">
                                                <input class="input-style" type="text" id="searchmaterialname" name="searchmaterialname"
                                                    style="width: 115px; height: 25px; padding: 5px; font-size: 12px;">
                                            </div>
                                        </th>
                                        ...
                                        <th scope="background-color: skyblue;" style="text-align: center; vertical-align: middle;">
                                            Droppint
                                            <div style="display: flex; justify-content: center; align-items: center; margin-top: 5px;">
                                                <input class="input-style" type="text" id="searchdroppint" name="searchdroppint"
                                                    style="width: 115px; height: 25px; padding: 5px; font-size: 12px;">
                                            </div>
                                        </th>

                                            <th scope="col" style="align-content: space-around;">Date</th>
                                            <th scope="col" style="align-content: space-around;">Transaction_ID</th>
                                            <th scope="col" style="align-content: space-around;">Available</th>
            ...
            <form class="WA" autocomplete="off" method="POST"
                action="/withdrawAdd">
                @csrf
                

                <div class="container">
                    <div class="Refdate" style=" width: 101%; display: flex; align-items: flex-end; justify-content: space-between;">
                            <div class="d-flex flex-wrap gap-3 align-items-center" style="margin-left: -10px; margin-block-start: 8px;"> 
                                <!-- Refcode -->

                                <div class="col-md-3" style="width: 170px;">
                                    <label for="refcode" class="form-label" style="justify-content: flex-start;  display: flex;" >Refcode</label>
                                ...
                                <!-- Date -->
                                <div>
                                    <label for="date" class="form-label" style="text-align: left; justify-content: flex-start;  display: flex;">Date</label>
                                ...
                                <!-- Button -->
                                <div class="bt">
                                    <button type="button" class="cssbuttons-io" data-bs-toggle="modal" data-bs-target="#showDataModal" id="showDataButton">
                                            <span>ประวัติการเบิกของ</span>
                                        </button>
                                </div>
                    </div>
                </div>
                ...
                <script>
                    function confirmSubmission(event) {
                        // แสดงกล่องยืนยัน
                        var userConfirmed = confirm("คุณต้องการเบิงของออกนี้หรือไม่?");
        ...
        <td><input type="text" name="droppoint[]" class="form-control" style="text-align: center; border: none; font-size: 9px; background-color: transparent;" value="${droppoint}" ></td>        
                                        ...
                                        response.imports.forEach(function(importData) {
                                            let row = `
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="droppoint[]" class="form-control" style="text-align: center; border: none; font-size:9px; background-color: transparent;" value="${importData.droppoint}" readonly></td>  
                                                    ...
                                                    <td><button type="button" class="btn btn-primary" style="font-size:9px;" onclick="removeRow(this)">ลบ</button></td>
                                                </tr>
                                            `;
...
<script>
   document.addEventListener('DOMContentLoaded', () => {
    const inputs = document.querySelectorAll('.input-style'); // เลือก input ทั้งหมดที่ใช้กรอง
    const table = document.getElementById('showDataTable'); // อ้างอิงตารางข้อมูล

    inputs.forEach((input, columnIndex) => {
        input.addEventListener('keyup', () => {
            const filterValue = input.value.toUpperCase();
            const rows = table.querySelectorAll('tbody tr'); // เลือกแถวใน tbody

            rows.forEach((row) => {
                const cell = row.cells[columnIndex + 1]; // อ้างอิงเซลล์ในแต่ละแถว
                if (cell) {
                    const cellValue = cell.textContent || cell.innerText;
                    if (cellValue.toUpperCase().indexOf(filterValue) > -1) {
                        row.style.display = ''; // แสดงแถวถ้าตรงกับคำค้นหา
                    } else {
                        row.style.display = 'none'; // ซ่อนแถวถ้าไม่ตรง
                    }
                }
            });
        });
