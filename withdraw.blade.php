    ...
    <div class="content" style="transition: margin-left 0.3s ease-in-out; padding-top: 60px;">
        ...
        <div class="container ">
            ...
            <form class="WA" autocomplete="off" method="POST"
                ...
                <div class="container">
                    <div class="Refdate" style="display: flex; align-items: flex-end; justify-content: space-between;">
                            <div class="d-flex flex-wrap gap-3 align-items-center"> 
                                <!-- Refcode -->
                                <div>
                                    <label for="refcode" class="form-label" style="text-align: left; justify-content: flex-start;  display: flex;">Refcode</label>
