    ...
    <!-- Content -->
        ...
        <div class="container ">
            ...
            <form class="WA" autocomplete="off" method="POST"
                ...
                <div class="nametable"><span style="display:flex; justify-content: center; gap:5px; ">เบิกของ<i class="fa-solid fa-hand-holding-heart"></i></span></div>
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        function filterTable() {
            ...
            rows.forEach(row => {
                const refcode = row.cells[1].textContent.toLowerCase();
                const refcodeWithdraw = row.cells[2].textContent.toLowerCase();
                const materialCode = row.cells[3].textContent.toLowerCase();
                const materialName = row.cells[4].textContent.toLowerCase();
        ...
        function filterTable() {
            ...
            rows.forEach(row => {
                ...
                filterInputs.forEach((input, index) => {
                    ...
                    const cellValue = row.cells[index]?.textContent.trim().toUpperCase() || ''; // ค่าจากเซลล์
