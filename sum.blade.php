                ...
                <div class="table-container ">
                    <table class="table" id="table">
                        <thead style="font-size: 12px; text-align:center">
                            <tr>
                                <th scope="background-color: skyblue" style=" justify-items: center;">Refcode 
                                    <input placeholder=" " class="input-style" type="text" id="RefcodeSearch" name="search" style="display: flex; width: 100%px; height: 22px; ">
                                </th>
                                <th scope="background-color: skyblue" style=" justify-items: center;">Droppoint
                                    <input placeholder=" " class="input-style" type="text" id="DroppointSearch" name="search" style="display: flex; width: 100%px; height: 22px; ">
                                </th>
                                <th scope="background-color: skyblue" style=" justify-items: center;">Material_code
                                    <input placeholder=" " class="input-style" type="text" id="MaterialcodeSearch" name="search" style="display: flex; width: 100%px; height: 22px; ">
                                </th>
                                <th scope="background-color: skyblue" style=" justify-items: center;">Material_name
                                    <input placeholder=" " class="input-style" type="text" id="MatterialnameSearch" name="search" style="display: flex; width: 100%px; height: 22px; ">
                                </th>
                                <th scope="background-color: skyblue">Spec
                                    <input placeholder=" " class="input-style" type="text" id="SpecSearch" name="search" style="display: flex; width: 100%px; height: 22px; ">
                                </th>

                                <th scope="background-color: skyblue" style="justify-items: center;">Unit</th>
